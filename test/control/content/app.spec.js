describe('Unit: eventsManualPluginContent content app', function () {
  describe('Unit: app routes', function () {
    ...
    describe('Create event route', function () {
      beforeEach(inject(
        function ($httpBackend) {
          $httpBackend.expectGET('templates/event.html')
            .respond(200);
    ...
    describe('Edit event route', function () {
      beforeEach(inject(
        function ($httpBackend) {
          $httpBackend.expectGET('templates/event.html')
            .respond(200);
